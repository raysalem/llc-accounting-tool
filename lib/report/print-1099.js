...
// "1099 Data" sheet. (It also builds CSV text that is never written; see todo.md.)
const path = require('path');
const { NORM_VEND } = require('./cells');

function print1099Report(ctx) {
    const {
        THRESHOLD_1099_NEC, filename, payerInfo, reports, show1099, show1099All, show1099INT,
